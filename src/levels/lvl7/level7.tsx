/**
 * Level 7 – раскладываем 8 предметов от самого маленького к самому большому
 * Логика полностью повторяет Level 1 (flex-верстка + dnd-kit)
 */
          ...
          <button className="icon-btn"
                  ...
                  onClick={()=>setSnack(
                    <Snackbar before={<Icon16Cancel/>}
                      ...
                      Разложи предметы от самого крошечного
                      до самого большого!
                    </Snackbar>
                  )}/>
        </div>
